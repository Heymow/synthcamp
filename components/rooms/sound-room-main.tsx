        ...
        <div className="flex flex-1 items-center gap-6">
          ...
          <div className="space-y-1">
            <div className="mb-0.5 flex items-center gap-3 text-white/70">
              <span className="text-[9px] font-black tracking-[0.4em] text-indigo-400 uppercase">
                On Air
              </span>
            ...
            <h3 className="text-3xl leading-none font-black tracking-tight text-white uppercase italic drop-shadow-lg">
              {MAIN_ROOM.title}
            </h3>
            <p className="pt-0.5 text-[13px] font-bold tracking-[0.2em] text-indigo-300 uppercase">
              by {MAIN_ROOM.artist}
            </p>
            <p className="pt-0.5 text-sm font-medium text-white italic">{MAIN_ROOM.tagline}</p>
            <div className="space-y-1.5 pt-2">
              ...
              <span className="block text-[8px] font-bold tracking-[0.1em] text-white/70 uppercase italic drop-shadow-md">
                {MAIN_ROOM.countries}
              </span>
            </div>
          </div>
